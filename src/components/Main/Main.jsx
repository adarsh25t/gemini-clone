    ...
    return (
        <div className='text-white p-5 w-full'>
            ...
            <div className="flex flex-col items-center justify-center w-full">
                <h1 class="text-gradient text-7xl font-bold text-zinc-600 pl-3">
                ...
                <div className="absolute bottom-3 w-full flex flex-col gap-2 justify-center items-center">
                    <div className="w-[850px] bg-zinc-800 h-16 rounded-full  relative">
                        <input 
                            type="text" 
                        ...
                        <div className="flex h-full items-center gap-1 absolute right-3 top-0">
                            ...
                            <TbArrowBigRightLinesFilled className='text-gray-300 cursor-pointer text-4xl p-2 rounded-full hover:bg-zinc-900'/>
                        </div>
                    </div>
